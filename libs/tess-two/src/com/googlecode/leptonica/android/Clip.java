...
public class Clip {
    ...
    /** Return true if pixs can be clipped to foreground. False otherwise. 1bpp only. */
    public static boolean testClipToForeground(Pix pixs) 
    {
        return nativePixTestClipToForeground(pixs.getNativePix());
    }
    
    /** Clip pixs to only the foreground pixels. 1bpp only. */
    public static Pix clipToForeground(Pix pixs) 
    {
        long nativePix = nativePixClipToForeground(pixs.getNativePix());
    ...
    private static native boolean nativePixTestClipToForeground(long nativePix);
    private static native long nativePixClipToForeground(long nativePix);
}