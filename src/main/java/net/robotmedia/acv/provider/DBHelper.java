...
public class DBHelper
{
  ...
  private static final String INSERT_FILE = "INSERT INTO " + DBOpenHelper.FILES_TABLE + " (" + DBOpenHelper.PATH_COLUMN
      + ", " + DBOpenHelper.OPENED_COLUMN + ", " + DBOpenHelper.READ_COLUMN + ", " + DBOpenHelper.BOOKMARK_COLUMN
      + ", " + DBOpenHelper.VIEWS_COLUMN + ", " + DBOpenHelper.FAVORITE_COLUMN + ") values (?, ?, 1, 0, 0, 0)";

  private static final String UPDATE_BOOKMARK = "UPDATE " + DBOpenHelper.FILES_TABLE + " SET "
      + DBOpenHelper.BOOKMARK_COLUMN + " = ? WHERE " + DBOpenHelper.PATH_COLUMN + " = ?";

  private static final String INCREASE_VIEWS = "UPDATE " + DBOpenHelper.FILES_TABLE + " SET "
      + DBOpenHelper.VIEWS_COLUMN + " = " + DBOpenHelper.VIEWS_COLUMN + " + 1 WHERE " + DBOpenHelper.PATH_COLUMN
      + " = ?";

  private static final String UPDATE_OPENED = "UPDATE " + DBOpenHelper.FILES_TABLE + " SET "
      + DBOpenHelper.OPENED_COLUMN + " = ? " + "WHERE " + DBOpenHelper.PATH_COLUMN + " = ?";
  ...
  {
    final Cursor cursor = mDB.query(DBOpenHelper.FILES_TABLE, new String[] { DBOpenHelper.PATH_COLUMN },
        DBOpenHelper.PATH_COLUMN + " = ? ", new String[] { path }, null, null, null);
  ...
  {
    final Cursor cursor = mDB.query(DBOpenHelper.FILES_TABLE, new String[] { DBOpenHelper.BOOKMARK_COLUMN },
        DBOpenHelper.PATH_COLUMN + " = ? ", new String[] { path }, null, null, null);
  ...
  {
    Cursor cursor = mDB.query(DBOpenHelper.FILES_TABLE, new String[] { DBOpenHelper.PATH_COLUMN }, null, null, null,
        null, DBOpenHelper.OPENED_COLUMN + " desc", "1");
  ...
  public List<String> getRecentFiles()
  {
    ...
    Cursor cursor = mDB.query(DBOpenHelper.FILES_TABLE, new String[] { DBOpenHelper.PATH_COLUMN }, null, null, null,
        null, DBOpenHelper.OPENED_COLUMN + " desc", "10");
