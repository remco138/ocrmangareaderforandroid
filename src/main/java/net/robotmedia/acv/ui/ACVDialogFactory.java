...
public class ACVDialogFactory
{
  ...
  {
    AlertDialog dialog = new AlertDialog.Builder(viewer).setIcon(android.R.drawable.ic_menu_close_clear_cancel)
        .setTitle(R.string.dialog_load_error_title).setMessage(R.string.dialog_load_error_text)
  ...
  {
    AlertDialog dialog = new AlertDialog.Builder(viewer).setIcon(android.R.drawable.ic_menu_close_clear_cancel)
        .setTitle(R.string.dialog_page_error_title).setMessage(R.string.dialog_page_error_text)
        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface dialog, int whichButton)
          {
  ...
  {
    AlertDialog dialog = new AlertDialog.Builder(viewer).setIcon(android.R.drawable.ic_menu_info_details)
        .setTitle(R.string.dialog_flip_controls_title).setMessage(viewer.getString(R.string.dialog_flip_controls_text))
