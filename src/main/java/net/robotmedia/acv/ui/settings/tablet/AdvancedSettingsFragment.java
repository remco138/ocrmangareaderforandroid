...
public class AdvancedSettingsFragment extends ExtendedPreferenceFragment
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    this.showValueOnSummary(PreferencesController.PREFERENCE_MAX_ZOOM);
    this.showValueOnSummary(PreferencesController.PREFERENCE_ZOOM_STEP);
    this.showValueOnSummary(PreferencesController.PREFERENCE_SCROLL_STEP);
  }
