...
public class ZipComic extends Comic
{
  ...
  protected File extract(ZipEntry entry, String name)
  {
    ...
    {
      Log.e("ZipComic", "Exception in extract()! " + e);
      e.printStackTrace();
  ...
  protected Drawable getDrawable(String entryName)
  {
    ...
    switch (status)
    {
      ...
      case ORIGINAL:
        ...
        {
          // HACK: The temp file was deleted, so we're back to square one. Unknown is not the best
      ...
      default:
        ...
        if (bitmap == null)
        {
          ...
          if (status == null)
          {
            status = ImageState.UNKNOWN; // This shouldn't happen
          }
