...
public class ControlSettingsActivity extends ExtendedPreferenceActivity
{
    ...
    public final String[] customControlKeys = new String[] { Constants.SINGLE_TAP_KEY, Constants.INPUT_DOUBLE_TAP,
            ...
            Constants.INPUT_CORNER_BOTTOM_LEFT, Constants.INPUT_CORNER_BOTTOM_RIGHT, Constants.INPUT_CORNER_TOP_LEFT,
            Constants.INPUT_CORNER_TOP_RIGHT, Constants.BACK_KEY, Constants.INPUT_VOLUME_UP, Constants.INPUT_VOLUME_DOWN
                                                           };
